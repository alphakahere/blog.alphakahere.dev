...
const Header = () => {
	...
	if (router.asPath === "/") {
		return (
			<header className="pt-2 bg-white dark:bg-dark relative  2xl:min-h-[60vh] overflow-x-hidden header border-b dark:border-gray-900 pb-10">
	...
	return (
		<header className="text-white bg-white dark:bg-dark border-b border-gray-200 dark:border-gray-900">
			<Navbar />
		</header>
	);
};
